...
public class FieldTestInfiniteScrollEntityResourceIT {
    ...
    @Test
    @Transactional
    public void checkDurationRequiredHugoIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestInfiniteScrollEntityRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    public void checkUuidRequiredHugoIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestInfiniteScrollEntityRepository.findAll().size();
        // set the field null
