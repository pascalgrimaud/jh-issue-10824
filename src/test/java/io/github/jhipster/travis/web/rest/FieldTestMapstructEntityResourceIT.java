...
/**
 * Integration tests for the {@link FieldTestMapstructEntityResource} REST controller.
 */
@SpringBootTest(classes = TravisNg2App.class)
public class FieldTestMapstructEntityResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static FieldTestMapstructEntity createUpdatedEntity(EntityManager em) {
        FieldTestMapstructEntity fieldTestMapstructEntity = new FieldTestMapstructEntity()
    ...
    public void createFieldTestMapstructEntity() throws Exception {
        ...
        assertThat(testFieldTestMapstructEntity.getDurationEva()).isEqualTo(DEFAULT_DURATION_EVA);
        assertThat(testFieldTestMapstructEntity.getDurationRequiredEva()).isEqualTo(DEFAULT_DURATION_REQUIRED_EVA);
        ...
        assertThat(testFieldTestMapstructEntity.getUuidEva()).isEqualTo(DEFAULT_UUID_EVA);
        assertThat(testFieldTestMapstructEntity.getUuidRequiredEva()).isEqualTo(DEFAULT_UUID_REQUIRED_EVA);
    ...
    @Test
    @Transactional
    public void checkDurationRequiredEvaIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestMapstructEntityRepository.findAll().size();
        // set the field null
        fieldTestMapstructEntity.setDurationRequiredEva(null);
    ...
    @Test
    @Transactional
    public void checkUuidRequiredEvaIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestMapstructEntityRepository.findAll().size();
        // set the field null
        fieldTestMapstructEntity.setUuidRequiredEva(null);
    ...
    public void updateFieldTestMapstructEntity() throws Exception {
        ...
        assertThat(testFieldTestMapstructEntity.getDurationEva()).isEqualTo(UPDATED_DURATION_EVA);
        assertThat(testFieldTestMapstructEntity.getDurationRequiredEva()).isEqualTo(UPDATED_DURATION_REQUIRED_EVA);
        ...
        assertThat(testFieldTestMapstructEntity.getUuidEva()).isEqualTo(UPDATED_UUID_EVA);
        assertThat(testFieldTestMapstructEntity.getUuidRequiredEva()).isEqualTo(UPDATED_UUID_REQUIRED_EVA);
    ...
    public void deleteFieldTestMapstructEntity() throws Exception {
        ...
        // Delete the fieldTestMapstructEntity
