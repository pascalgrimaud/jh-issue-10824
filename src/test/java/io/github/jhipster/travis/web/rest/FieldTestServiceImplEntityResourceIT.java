...
public class FieldTestServiceImplEntityResourceIT {
    ...
    @Test
    @Transactional
    public void checkDurationRequiredMikaIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestServiceImplEntityRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    public void checkUuidRequiredMikaIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestServiceImplEntityRepository.findAll().size();
        // set the field null
