...
public class FieldTestPaginationEntityResourceIT {
    ...
    @Test
    @Transactional
    public void checkDurationRequiredAliceIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestPaginationEntityRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    public void checkUuidRequiredAliceIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestPaginationEntityRepository.findAll().size();
        // set the field null
