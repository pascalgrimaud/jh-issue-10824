...
import io.github.jhipster.travis.service.dto.BankAccountCriteria;
import io.github.jhipster.travis.service.BankAccountQueryService;
...
public class BankAccountResourceIT {
    ...
    @Test
    @Transactional
    public void getAllBankAccountsByGuidIsEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where guid equals to DEFAULT_GUID
        defaultBankAccountShouldBeFound("guid.equals=" + DEFAULT_GUID);

        // Get all the bankAccountList where guid equals to UPDATED_GUID
        defaultBankAccountShouldNotBeFound("guid.equals=" + UPDATED_GUID);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByGuidIsNotEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where guid not equals to DEFAULT_GUID
        defaultBankAccountShouldNotBeFound("guid.notEquals=" + DEFAULT_GUID);

        // Get all the bankAccountList where guid not equals to UPDATED_GUID
        defaultBankAccountShouldBeFound("guid.notEquals=" + UPDATED_GUID);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByGuidIsInShouldWork() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where guid in DEFAULT_GUID or UPDATED_GUID
        defaultBankAccountShouldBeFound("guid.in=" + DEFAULT_GUID + "," + UPDATED_GUID);

        // Get all the bankAccountList where guid equals to UPDATED_GUID
        defaultBankAccountShouldNotBeFound("guid.in=" + UPDATED_GUID);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByGuidIsNullOrNotNull() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where guid is not null
        defaultBankAccountShouldBeFound("guid.specified=true");

        // Get all the bankAccountList where guid is null
        defaultBankAccountShouldNotBeFound("guid.specified=false");
    }
    ...
    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration equals to DEFAULT_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.equals=" + DEFAULT_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration equals to UPDATED_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.equals=" + UPDATED_MEAN_QUEUE_DURATION);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsNotEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration not equals to DEFAULT_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.notEquals=" + DEFAULT_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration not equals to UPDATED_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.notEquals=" + UPDATED_MEAN_QUEUE_DURATION);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsInShouldWork() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration in DEFAULT_MEAN_QUEUE_DURATION or UPDATED_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.in=" + DEFAULT_MEAN_QUEUE_DURATION + "," + UPDATED_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration equals to UPDATED_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.in=" + UPDATED_MEAN_QUEUE_DURATION);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsNullOrNotNull() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration is not null
        defaultBankAccountShouldBeFound("meanQueueDuration.specified=true");

        // Get all the bankAccountList where meanQueueDuration is null
        defaultBankAccountShouldNotBeFound("meanQueueDuration.specified=false");
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration is greater than or equal to DEFAULT_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.greaterThanOrEqual=" + DEFAULT_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration is greater than or equal to UPDATED_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.greaterThanOrEqual=" + UPDATED_MEAN_QUEUE_DURATION);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration is less than or equal to DEFAULT_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.lessThanOrEqual=" + DEFAULT_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration is less than or equal to SMALLER_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.lessThanOrEqual=" + SMALLER_MEAN_QUEUE_DURATION);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsLessThanSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration is less than DEFAULT_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.lessThan=" + DEFAULT_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration is less than UPDATED_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.lessThan=" + UPDATED_MEAN_QUEUE_DURATION);
    }

    @Test
    @Transactional
    public void getAllBankAccountsByMeanQueueDurationIsGreaterThanSomething() throws Exception {
        // Initialize the database
        bankAccountRepository.saveAndFlush(bankAccount);

        // Get all the bankAccountList where meanQueueDuration is greater than DEFAULT_MEAN_QUEUE_DURATION
        defaultBankAccountShouldNotBeFound("meanQueueDuration.greaterThan=" + DEFAULT_MEAN_QUEUE_DURATION);

        // Get all the bankAccountList where meanQueueDuration is greater than SMALLER_MEAN_QUEUE_DURATION
        defaultBankAccountShouldBeFound("meanQueueDuration.greaterThan=" + SMALLER_MEAN_QUEUE_DURATION);
    }
