...
export class EntityWithServiceImplPaginationAndDTODeleteDialog {
  private dialogTitle: ElementFinder = element(by.id('travisNg2App.entityWithServiceImplPaginationAndDTO.delete.question'));
  private confirmButton = element(by.id('custom-confirm-delete-entityWithServiceImplPaginationAndDTO'));
