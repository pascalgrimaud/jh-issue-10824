...
export class EntityWithServiceImplAndPaginationDeleteDialog {
  private dialogTitle: ElementFinder = element(by.id('travisNg2App.entityWithServiceImplAndPagination.delete.question'));
  private confirmButton = element(by.id('custom-confirm-delete-entityWithServiceImplAndPagination'));
