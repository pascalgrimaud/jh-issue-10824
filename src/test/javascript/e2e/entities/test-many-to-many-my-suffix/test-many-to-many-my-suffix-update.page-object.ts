...
export default class TestManyToManyUpdatePage {
  pageTitle: ElementFinder = element(by.id('travisNg2App.testManyToMany.home.createOrEditLabel'));
  ...
  superMegaLargeTestEntitySelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-superMegaLargeTestEntity'));
