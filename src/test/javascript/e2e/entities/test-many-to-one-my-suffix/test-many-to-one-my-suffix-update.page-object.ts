...
export default class TestManyToOneUpdatePage {
  pageTitle: ElementFinder = element(by.id('travisNg2App.testManyToOne.home.createOrEditLabel'));
  ...
  superMegaLargeTestEntitySelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-superMegaLargeTestEntity'));
