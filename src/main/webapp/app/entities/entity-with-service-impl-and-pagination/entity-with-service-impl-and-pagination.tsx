    ...
    return (
      <div>
        <h2 id="entity-with-service-impl-and-pagination-heading">
          <Translate contentKey="travisNg2App.entityWithServiceImplAndPagination.home.title">
            Entity With Service Impl And Paginations
          </Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisNg2App.entityWithServiceImplAndPagination.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithServiceImplAndPaginationList && entityWithServiceImplAndPaginationList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisNg2App.entityWithServiceImplAndPagination.home.notFound">
