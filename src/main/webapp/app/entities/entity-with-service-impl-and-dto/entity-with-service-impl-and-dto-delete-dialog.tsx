  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisNg2App.entityWithServiceImplAndDTO.delete.question">
          <Translate
            contentKey="travisNg2App.entityWithServiceImplAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="custom-confirm-delete-entityWithServiceImplAndDTO" color="danger" onClick={this.confirmDelete}>
