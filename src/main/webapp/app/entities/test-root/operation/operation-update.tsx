    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisNg2App.testRootOperation.home.createOrEditLabel">
              <Translate contentKey="travisNg2App.testRootOperation.home.createOrEditLabel">Create or edit a Operation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : operationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="dateLabel" for="operation-date">
                    <Translate contentKey="travisNg2App.testRootOperation.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="operation-date"
                    type="datetime-local"
                ...
                <AvGroup>
                  <Label id="amountLabel" for="operation-amount">
                    <Translate contentKey="travisNg2App.testRootOperation.amount">Amount</Translate>
                  </Label>
                  <AvField
                    id="operation-amount"
                    type="text"
                ...
                <AvGroup>
                  <Label for="operation-label">
                    <Translate contentKey="travisNg2App.testRootOperation.label">Label</Translate>
                  </Label>
                  <AvInput
                    id="operation-label"
                    type="select"
