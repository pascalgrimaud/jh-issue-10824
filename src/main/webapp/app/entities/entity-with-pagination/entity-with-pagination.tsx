    ...
    return (
      <div>
        <h2 id="entity-with-pagination-heading">
          <Translate contentKey="travisNg2App.entityWithPagination.home.title">Entity With Paginations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisNg2App.entityWithPagination.home.createLabel">Create a new Entity With Pagination</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {entityWithPaginationList && entityWithPaginationList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('nathan')}>
                    <Translate contentKey="travisNg2App.entityWithPagination.nathan">Nathan</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisNg2App.entityWithPagination.home.notFound">No Entity With Paginations found</Translate>
            </div>
          )}
        </div>
