  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisNg2App.fieldTestInfiniteScrollEntity.delete.question">
          <Translate
            contentKey="travisNg2App.fieldTestInfiniteScrollEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="custom-confirm-delete-fieldTestInfiniteScrollEntity" color="danger" onClick={this.confirmDelete}>
