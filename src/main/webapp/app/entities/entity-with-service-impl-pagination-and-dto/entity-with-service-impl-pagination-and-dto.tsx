    ...
    return (
      <div>
        <h2 id="entity-with-service-impl-pagination-and-dto-heading">
          <Translate contentKey="travisNg2App.entityWithServiceImplPaginationAndDTO.home.title">
            Entity With Service Impl Pagination And DTOS
          </Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisNg2App.entityWithServiceImplPaginationAndDTO.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithServiceImplPaginationAndDTOList && entityWithServiceImplPaginationAndDTOList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisNg2App.entityWithServiceImplPaginationAndDTO.home.notFound">
