  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisNg2App.entityWithServiceImplPaginationAndDTO.delete.question">
          <Translate
            contentKey="travisNg2App.entityWithServiceImplPaginationAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="custom-confirm-delete-entityWithServiceImplPaginationAndDTO" color="danger" onClick={this.confirmDelete}>
