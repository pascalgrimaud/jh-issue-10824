...
export class EntityWithDTOUpdate extends React.Component<IEntityWithDTOUpdateProps, IEntityWithDTOUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/entity-with-dto');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisNg2App.entityWithDTO.home.createOrEditLabel">
              <Translate contentKey="travisNg2App.entityWithDTO.home.createOrEditLabel">Create or edit a EntityWithDTO</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
