...
export interface IEntityWithDTODeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisNg2App.entityWithDTO.delete.question">
          <Translate contentKey="travisNg2App.entityWithDTO.delete.question" interpolate={{ id: entityWithDTOEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="custom-confirm-delete-entityWithDTO" color="danger" onClick={this.confirmDelete}>
