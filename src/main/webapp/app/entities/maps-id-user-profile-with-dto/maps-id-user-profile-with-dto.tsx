    ...
    return (
      <div>
        <h2 id="maps-id-user-profile-with-dto-heading">
          <Translate contentKey="travisNg2App.mapsIdUserProfileWithDTO.home.title">Maps Id User Profile With DTOS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisNg2App.mapsIdUserProfileWithDTO.home.createLabel">
        ...
        <div className="table-responsive">
          {mapsIdUserProfileWithDTOList && mapsIdUserProfileWithDTOList.length > 0 ? (
            <Table responsive aria-describedby="maps-id-user-profile-with-dto-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="travisNg2App.mapsIdUserProfileWithDTO.dateOfBirth">Date Of Birth</Translate>
                  </th>
                  <th>
                    <Translate contentKey="travisNg2App.mapsIdUserProfileWithDTO.user">User</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisNg2App.mapsIdUserProfileWithDTO.home.notFound">
