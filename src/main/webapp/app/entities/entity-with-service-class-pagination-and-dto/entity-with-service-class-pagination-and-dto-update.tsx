    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisNg2App.entityWithServiceClassPaginationAndDTO.home.createOrEditLabel">
              <Translate contentKey="travisNg2App.entityWithServiceClassPaginationAndDTO.home.createOrEditLabel">
