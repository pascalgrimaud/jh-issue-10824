    ...
    return (
      <div>
        <h2 id="entity-with-service-class-pagination-and-dto-heading">
          <Translate contentKey="travisNg2App.entityWithServiceClassPaginationAndDTO.home.title">
            Entity With Service Class Pagination And DTOS
          </Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="travisNg2App.entityWithServiceClassPaginationAndDTO.home.createLabel">
        ...
        <div className="table-responsive">
          {entityWithServiceClassPaginationAndDTOList && entityWithServiceClassPaginationAndDTOList.length > 0 ? (
            <Table responsive aria-describedby="entity-with-service-class-pagination-and-dto-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('lena')}>
                    <Translate contentKey="travisNg2App.entityWithServiceClassPaginationAndDTO.lena">Lena</Translate>{' '}
            ...
            <div className="alert alert-warning">
              <Translate contentKey="travisNg2App.entityWithServiceClassPaginationAndDTO.home.notFound">
