  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="travisNg2App.entityWithServiceClassPaginationAndDTO.detail.title">
          ...
          <Button tag={Link} to="/entity-with-service-class-pagination-and-dto" replace color="info">
