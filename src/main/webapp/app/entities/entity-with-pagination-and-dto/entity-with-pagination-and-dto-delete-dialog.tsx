  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="travisNg2App.entityWithPaginationAndDTO.delete.question">
          <Translate
            contentKey="travisNg2App.entityWithPaginationAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="custom-confirm-delete-entityWithPaginationAndDTO" color="danger" onClick={this.confirmDelete}>
