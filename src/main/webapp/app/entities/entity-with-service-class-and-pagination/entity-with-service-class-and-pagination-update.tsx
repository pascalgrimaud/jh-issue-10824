...
> {
  ...
  handleClose = () => {
    this.props.history.push('/entity-with-service-class-and-pagination');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisNg2App.entityWithServiceClassAndPagination.home.createOrEditLabel">
              <Translate contentKey="travisNg2App.entityWithServiceClassAndPagination.home.createOrEditLabel">
