...
export interface ITestPaginationUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
...
export class TestPaginationUpdate extends React.Component<ITestPaginationUpdateProps, ITestPaginationUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/test-pagination');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="travisNg2App.testPagination.home.createOrEditLabel">
              <Translate contentKey="travisNg2App.testPagination.home.createOrEditLabel">Create or edit a TestPagination</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : testPaginationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="test-pagination-userOneToMany">
                    <Translate contentKey="travisNg2App.testPagination.userOneToMany">User One To Many</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="test-pagination-userManyToMany">
                    <Translate contentKey="travisNg2App.testPagination.userManyToMany">User Many To Many</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="test-pagination-userOneToOne">
                    <Translate contentKey="travisNg2App.testPagination.userOneToOne">User One To One</Translate>
                  </Label>
                ...
                <Button tag={Link} id="cancel-save" to="/test-pagination" replace color="info">
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  updateSuccess: storeState.testPagination.updateSuccess
});
