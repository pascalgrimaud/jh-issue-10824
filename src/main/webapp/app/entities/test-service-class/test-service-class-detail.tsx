...
export interface ITestServiceClassDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="travisNg2App.testServiceClass.detail.title">TestServiceClass</Translate> [
            <b>{testServiceClassEntity.id}</b>]
          </h2>
          ...
          <Button tag={Link} to="/test-service-class" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/test-service-class/${testServiceClassEntity.id}/edit`} replace color="primary">
