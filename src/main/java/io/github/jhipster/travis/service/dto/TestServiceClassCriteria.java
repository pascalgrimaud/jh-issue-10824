...
/**
 * Criteria class for the {@link io.github.jhipster.travis.domain.TestServiceClass} entity. This class is used
 * in {@link io.github.jhipster.travis.web.rest.TestServiceClassResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /test-service-classes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class TestServiceClassCriteria implements Serializable, Criteria {
    ...
    public TestServiceClassCriteria(TestServiceClassCriteria other){
    ...
    @Override
    public TestServiceClassCriteria copy() {
        return new TestServiceClassCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TestServiceClassCriteria that = (TestServiceClassCriteria) o;
        return
